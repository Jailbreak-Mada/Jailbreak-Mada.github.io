...
function exploit(){
	if(document.getElementById('table') == null){
		...
		document.write('<marquee style="font-size:20px;color:white;margin-top:130px;">Tongasoa, Bienvenue sur Jailbreak Madagascar, le jailbreak Stable du moment!! Stable à 95%, j essayerai de mettre à jour continuellement l exploit pour de meilleurs stabilités, Nouveauté : HEN 2.1.3</marquee>'+
